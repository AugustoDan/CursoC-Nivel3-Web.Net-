<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MiPerfil.aspx.cs" Inherits="ArticulosWeb.MiPerfil" %>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <asp:Image ID="imgNuevoPerfil" ImageUrl="https://www.palomacornejo.com/wp-content/uploads/2021/08/no-image.jpg"
                runat="server" CssClass="img-fluid mb-3" style="width: 180px;margin-top: 10px;" />
